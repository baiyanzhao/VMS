...
namespace IKriv.Windows.Controls.Behaviors
{
	...
	{
		public static bool GetIsCached(DependencyObject o) => (bool)o?.GetValue(IsCachedProperty);

		public static void SetIsCached(DependencyObject o, bool value) => o?.SetValue(IsCachedProperty, value);
		...
		public static DataTemplate GetTemplate(DependencyObject o) => (DataTemplate)o?.GetValue(TemplateProperty);

		public static void SetTemplate(DependencyObject o, DataTemplate value) => o?.SetValue(TemplateProperty, value);
		...
		public static DataTemplateSelector GetTemplateSelector(DependencyObject o) => (DataTemplateSelector)o?.GetValue(TemplateSelectorProperty);

		public static void SetTemplateSelector(DependencyObject o, DataTemplateSelector value) => o?.SetValue(TemplateSelectorProperty, value);
		...
		public static TabControl GetInternalTabControl(DependencyObject o) => (TabControl)o?.GetValue(InternalTabControlProperty);

		[EditorBrowsable(EditorBrowsableState.Never)]
		public static void SetInternalTabControl(DependencyObject o, TabControl value) => o?.SetValue(InternalTabControlProperty, value);
		...
		[EditorBrowsable(EditorBrowsableState.Never)]
		public static ContentControl GetInternalCachedContent(DependencyObject o) => (ContentControl)o?.GetValue(InternalCachedContentProperty);

		[EditorBrowsable(EditorBrowsableState.Never)]
		public static void SetInternalCachedContent(DependencyObject o, ContentControl value) => o?.SetValue(InternalCachedContentProperty, value);
		...
		[EditorBrowsable(EditorBrowsableState.Never)]
		public static object GetInternalContentManager(DependencyObject o) => o?.GetValue(InternalContentManagerProperty);

		[EditorBrowsable(EditorBrowsableState.Never)]
		public static void SetInternalContentManager(DependencyObject o, object value) => o?.SetValue(InternalContentManagerProperty, value);
